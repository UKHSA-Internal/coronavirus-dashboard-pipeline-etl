...
try:
    from ..db_processors.db_preprocessor import process_by_age, DemographicsCategory
except ImportError:
    from demographic_etl.db_processors.db_preprocessor import process_by_age, DemographicsCategory
...
NEXT_DEPLOYMENT_PATH = "demographic/publish_date_cases/by_age/in_waiting/{filename}.csv"
...
async def create_publish_date_dataset():
    event_loop = get_event_loop()
...
if __name__ == '__main__':
    loop = get_event_loop()
    loop.run_until_complete(create_publish_date_dataset())
